...
var __create1 = Object.create;
var __defProp1 = Object.defineProperty;
var __getOwnPropDesc1 = Object.getOwnPropertyDescriptor;
var __getOwnPropNames1 = Object.getOwnPropertyNames;
var __getProtoOf1 = Object.getPrototypeOf;
var __hasOwnProp1 = Object.prototype.hasOwnProperty;
var __markAsModule1 = (target) =>
  __defProp1(target, "__esModule", {
    value: true,
  });
((x) =>
...
var __commonJS1 = (cb, mod) =>
  function __require2() {
    return mod || (0, cb[__getOwnPropNames1(cb)[0]])(
      (mod = {
        exports: {},
      }).exports,
      mod,
...
var __reExport1 = (target, module, copyDefault, desc) => {
  if (module && typeof module === "object" || typeof module === "function") {
    for (let key of __getOwnPropNames1(module)) {
      if (
        !__hasOwnProp1.call(target, key) && (copyDefault || key !== "default")
      ) {
        __defProp1(target, key, {
          get: () => module[key],
          enumerable: !(desc = __getOwnPropDesc1(module, key)) ||
            desc.enumerable,
        });
      }
    }
...
var __toESM1 = (module, isNodeMode) => {
  return __reExport1(
    __markAsModule1(__defProp1(
      module != null
        ? __create1(__getProtoOf1(module))
        : {},
      "default",
      !isNodeMode && module && module.__esModule
        ? {
...
var require_react_development = __commonJS1({
  "esm-build-1e2bfe6941e873316620f2736d8dd45835aace5a-7be4eb9a/node_modules/react/cjs/react.development.js"(
    exports,
  ) {
    "use strict";
    if (true) {
      (function () {
        ...
        var MAYBE_ITERATOR_SYMBOL = typeof Symbol === "function" &&
          Symbol.iterator;
        ...
        function escapeUserProvidedKey(text1) {
          return text1.replace(userProvidedKeyEscapeRegex, "$&/");
        }
        ...
        function isValidElementType(type) {
          ...
          if (
            type === exports.Fragment || type === exports.Profiler ||
            type === REACT_DEBUG_TRACING_MODE_TYPE ||
            type === exports.StrictMode || type === exports.Suspense ||
...
var require_react = __commonJS1({
  "esm-build-1e2bfe6941e873316620f2736d8dd45835aace5a-7be4eb9a/node_modules/react/index.js"(
    exports,
    module,
  ) {
    "use strict";
...
var import_react = __toESM1(require_react());
var $module1 = __toESM1(require_react());
var {
  Fragment,
  StrictMode,
  Profiler,
...
var { default: $def1, ...$rest1 } = $module1;
var mod_default1 = (import_react.default ?? $def1) ?? $rest1;
...
function Line(props) {
  ...
  const textDOM = [
    ...
    mod_default1.createElement("span", {
      className: `char-index c-${i + indent}`,
    }, c)
  );
  if (indent !== 0) {
    ...
    const indentDOM = Array.from(
      Array(indent),
      (_, i) =>
        mod_default1.createElement(
          "span",
          {
            className: `char-index c-${i}`,
          },
          mod_default1.createElement("span", {
            className: "pad",
            style: {
    ...
    indentDOM.push(mod_default1.createElement("span", {
      className: "dot",
      style: {
        display: "block",
        position: "absolute",
    ...
    return mod_default1.createElement(
      "div",
      {
        className: `line l-${props.lnum}`,
      },
      mod_default1.createElement("span", {
  ...
  return mod_default1.createElement("div", {
    className: `line l-${props.lnum}`,
  }, textDOM);
}
const {
  useLayoutEffect: useLayoutEffect1,
  useState: useState1,
  useRef: useRef1,
} = mod_default1;
...
function positionFromElement(element1, clientX, clientY) {
  ...
  const chars = Array.from(line.querySelectorAll(".char-index")).map(
    (element) => {
...
function Editor(props) {
  const [cursor, setCursor] = useState1(defaultPosition);
  const [cursorView, setCursorView] = useState1({
    left: 0,
    top: 0,
    height: 0,
  });
  const selectionStart = useRef1(defaultPosition);
  const [selection1, setSelection] = useState1(defaultSelection);
  const [selectionView, setSelectionView] = useState1({
    top: {
      left: 0,
      top: 0,
      width: 0,
  ...
  useLayoutEffect1(() => {
    ...
    const __char = document.querySelector(
  ...
  useLayoutEffect1(() => {
    const startlen = Math.min(
      (props.lines[selection1.start.line]?.length ?? 0) - 1,
      selection1.start.column,
    );
    const start = document.querySelector(
      `.l-${selection1.start.line} .c-${startlen}`,
    );
    const endlen = Math.min(
      (props.lines[selection1.end.line]?.length ?? 0) - 1,
      selection1.end.column,
    );
    const end = document.querySelector(
      `.l-${selection1.end.line} .c-${endlen}`,
    );
    if (!start || !end) {
      setSelectionView({
        top: {
    ...
    if (endRect.top < startRect.top + startRect.height / 2) {
      const view = {
        ...startRect,
        width: endRect.left + (endlen + 1 === selection1.end.column
          ? endRect.width
          : 0) -
          startRect.left,
      };
      ...
      const topLeft = startRect.left +
        (startlen + 1 === selection1.start.column ? startRect.width : 0);
      const top = {
        ...startRect,
        left: topLeft,
      ...
      const bottom = {
        ...
        width: endRect.left - lineRect.left +
          (endlen + 1 === selection1.end.column ? endRect.width : 0),
      };
      setSelectionView({
        top,
        center,
  ...
  return mod_default1.createElement(
    ...
    mod_default1.createElement(
      "span",
      null,
      mod_default1.createElement(SelectionView, {
        rect: selectionView.top,
      }),
      mod_default1.createElement(SelectionView, {
        rect: selectionView.center,
      }),
      mod_default1.createElement(SelectionView, {
        rect: selectionView.bottom,
      }),
    ),
    mod_default1.createElement(
      "span",
      ...
      props.lines.map((line, index) =>
        mod_default1.createElement(Line, {
          line: line,
          lnum: index,
        })
      ),
...
var __reExport2 = (target, module, copyDefault, desc) => {
  if (module && typeof module === "object" || typeof module === "function") {
    for (let key of __getOwnPropNames2(module)) {
      if (
        !__hasOwnProp2.call(target, key) && (copyDefault || key !== "default")
      ) {
        __defProp2(target, key, {
          get: () => module[key],
          enumerable: !(desc = __getOwnPropDesc2(module, key)) ||
            desc.enumerable,
        });
      }
    }
...
var __toESM2 = (module, isNodeMode) => {
  return __reExport2(
    __markAsModule2(__defProp2(
      module != null
        ? __create2(__getProtoOf2(module))
        : {},
      "default",
      !isNodeMode && module && module.__esModule
        ? {
...
var require_scheduler_tracing_development = __commonJS2({
    ...
    if (true) {
      (function () {
        ...
        function unstable_trace2(name, timestamp, callback) {
          var threadID = arguments.length > 3 && arguments[3] !== void 0
            ? arguments[3]
            : DEFAULT_THREAD_ID;
          var interaction = {
            __count: 1,
        ...
        function unstable_wrap2(callback) {
          var threadID = arguments.length > 1 && arguments[1] !== void 0
            ? arguments[1]
            : DEFAULT_THREAD_ID;
...
var import_tracing = __toESM2(require_tracing());
var $module2 = __toESM2(require_tracing());
var {
  __interactionsRef,
  __subscriberRef,
  unstable_clear,
...
var mod_default2 = (import_tracing.default ?? $def2) ?? $rest2;
...
var __markAsModule3 = (target) =>
  __defProp3(target, "__esModule", {
    value: true,
  });
var __commonJS3 = (cb, mod) =>
  function __require() {
    return mod || (0, cb[__getOwnPropNames3(cb)[0]])(
      (mod = {
        exports: {},
      }).exports,
      mod,
...
var __reExport3 = (target, module, copyDefault, desc) => {
  if (module && typeof module === "object" || typeof module === "function") {
    for (let key of __getOwnPropNames3(module)) {
      if (
        !__hasOwnProp3.call(target, key) && (copyDefault || key !== "default")
      ) {
        __defProp3(target, key, {
          get: () => module[key],
          enumerable: !(desc = __getOwnPropDesc3(module, key)) ||
            desc.enumerable,
        });
      }
    }
...
var __toESM3 = (module, isNodeMode) => {
  return __reExport3(
    __markAsModule3(__defProp3(
      module != null
        ? __create3(__getProtoOf3(module))
        : {},
      "default",
      !isNodeMode && module && module.__esModule
        ? {
...
var require_scheduler_development = __commonJS3({
  "esm-build-cd8ade602a33e4c4467dd793ec8c93282f218565-d47ef742/node_modules/scheduler/cjs/scheduler.development.js"(
    exports,
  ) {
    "use strict";
    if (true) {
      (function () {
        ...
        exports.unstable_getCurrentPriorityLevel =
          unstable_getCurrentPriorityLevel2;
...
var require_scheduler = __commonJS3({
  "esm-build-cd8ade602a33e4c4467dd793ec8c93282f218565-d47ef742/node_modules/scheduler/index.js"(
    exports,
    module,
  ) {
    "use strict";
...
var import_scheduler = __toESM3(require_scheduler());
var $module3 = __toESM3(require_scheduler());
var {
  unstable_now,
...
var { default: $def3, ...$rest3 } = $module3;
var mod_default3 = (import_scheduler.default ?? $def3) ?? $rest3;
...
var __markAsModule4 = (target) =>
  __defProp4(target, "__esModule", {
    value: true,
  });
((x) =>
  typeof require !== "undefined"
...
var __commonJS4 = (cb, mod) =>
  function __require2() {
    return mod || (0, cb[__getOwnPropNames4(cb)[0]])(
      (mod = {
        exports: {},
      }).exports,
      mod,
...
var __reExport4 = (target, module, copyDefault, desc) => {
  if (module && typeof module === "object" || typeof module === "function") {
    for (let key of __getOwnPropNames4(module)) {
      if (
        !__hasOwnProp4.call(target, key) && (copyDefault || key !== "default")
      ) {
        __defProp4(target, key, {
          get: () => module[key],
          enumerable: !(desc = __getOwnPropDesc4(module, key)) ||
            desc.enumerable,
        });
      }
    }
...
var __toESM4 = (module, isNodeMode) => {
  return __reExport4(
    __markAsModule4(__defProp4(
      module != null
        ? __create4(__getProtoOf4(module))
        : {},
      "default",
      !isNodeMode && module && module.__esModule
        ? {
...
var require_react_dom_development = __commonJS4({
  "esm-build-2e9cd939fa91c0eeaf6f7ff27fca55411db625c4-fe81360e/node_modules/react-dom/cjs/react-dom.development.js"(
    exports,
  ) {
    "use strict";
    if (true) {
      (function () {
        "use strict";
        var React = mod_default1;
        var _assign = mod_default;
        var Scheduler = mod_default3;
        var tracing = mod_default2;
        var ReactSharedInternals =
        ...
        function listenToNativeEvent(
          ...
          var eventSystemFlags = arguments.length > 4 && arguments[4] !== void 0
            ? arguments[4]
            : 0;
        ...
        var normalizeHTML;
        {
          ...
          normalizeMarkupForTextOrAttribute = function (markup) {
            var markupString = typeof markup === "string"
              ? markup
              : "" + markup;
        ...
        function diffHydratedText(textNode, text4) {
        ...
        function shouldSetTextContent(type, props) {
          return type === "textarea" || type === "option" ||
            type === "noscript" || typeof props.children === "string" ||
            typeof props.children === "number" ||
            typeof props.dangerouslySetInnerHTML === "object" &&
        ...
        function unhideInstance(instance, props) {
          ...
          var display =
            styleProp !== void 0 && styleProp !== null &&
        ...
        function hydrateTextInstance(
          ...
          return diffHydratedText(textInstance, text10);
        }
        ...
        function didNotMatchHydratedContainerTextInstance(
          ...
          {
            warnForUnmatchedText(textInstance, text11);
          }
        }
        function didNotMatchHydratedTextInstance(
          ...
          if (parentProps[SUPPRESS_HYDRATION_WARNING$1] !== true) {
            warnForUnmatchedText(textInstance, text12);
          }
        }
        ...
        function didNotFindHydratableContainerTextInstance(
          ...
          {
            warnForInsertedHydratedText(parentContainer, text13);
          }
        }
        ...
        function didNotFindHydratableTextInstance(
          ...
          if (parentProps[SUPPRESS_HYDRATION_WARNING$1] !== true) {
            warnForInsertedHydratedText(parentInstance, text14);
          }
        }
        ...
        var requestPaint = Scheduler_requestPaint !== void 0
          ...
          switch (update.tag) {
            case ReplaceState: {
              ...
              if (typeof payload === "function") {
                ...
                {
                  if (workInProgress2.mode & StrictMode1) {
                    disableLogs();
                    try {
        ...
        function callComponentWillReceiveProps(
          ...
          if (instance.state !== oldState) {
            {
              var componentName = getComponentName(workInProgress2.type) ||
                "Component";
        ...
        };
        {
          ...
          warnForMissingKey = function (child, returnFiber) {
            ...
            var componentName = getComponentName(returnFiber.type) ||
              "Component";
        ...
        function coerceRef(returnFiber, current2, element) {
          ...
          if (
            ...
            {
              if (
                (returnFiber.mode & StrictMode1 || warnAboutStringRefs) &&
        ...
        function ChildReconciler(shouldTrackSideEffects) {
          ...
          function updateFragment2(
            ...
            if (current2 === null || current2.tag !== Fragment1) {
        ...
        function tryHydrate(fiber, nextInstance) {
          switch (fiber.tag) {
            ...
            case HostText: {
              var text16 = fiber.pendingProps;
              var textInstance = canHydrateTextInstance(nextInstance, text16);
            ...
            if (workInProgress2.type !== workInProgress2.elementType) {
              ...
              if (innerPropTypes) {
                checkPropTypes(
                  ...
                  nextProps,
                  "prop",
                  getComponentName(Component6),
                );
              }
            }
          }
          var render3 = Component6.render;
        ...
        function updateMemoComponent(
          ...
          if (current2 === null) {
            ...
            if (
              isSimpleFunctionComponent(type) && Component7.compare === null &&
        ...
        function finishClassComponent(
          ...
          if (
            didCaptureError &&
            typeof Component11.getDerivedStateFromError !== "function"
          ) {
            nextChildren = null;
            {
          ...
          if (root2.hydrate && enterHydrationState(workInProgress2)) {
            {
              ...
              if (mutableSourceEagerHydrationData != null) {
                for (
                  var i = 0; i < mutableSourceEagerHydrationData.length; i += 2
                ) {
        ...
        function mountLazyComponent(
          ...
          switch (resolvedTag) {
            case FunctionComponent: {
              {
                ...
                workInProgress2.type = Component12 =
                  resolveFunctionForHotReloading(Component12);
              }
            ...
            case ClassComponent: {
              {
                workInProgress2.type = Component12 =
                  resolveClassForHotReloading(Component12);
              }
            ...
            case ForwardRef: {
              {
                workInProgress2.type = Component12 =
                  resolveForwardRefForHotReloading(Component12);
              }
          ...
          {
            if (
              Component12 !== null && typeof Component12 === "object" &&
              Component12.$$typeof === REACT_LAZY_TYPE
            ) {
              hint =
        ...
        function mountIndeterminateComponent(
          ...
          {
            if (
              Component14.prototype &&
              typeof Component14.prototype.render === "function"
            ) {
        ...
        function validateFunctionComponentInDev(workInProgress2, Component15) {
          {
            if (Component15) {
              if (Component15.childContextTypes) {
                error(
                  ...
                  Component15.displayName || Component15.name || "Component",
                );
              }
            }
            ...
            if (
              typeof Component15.contextType === "object" &&
              Component15.contextType !== null
            ) {
        ...
        function updateContextProvider(
          ...
          if (oldProps !== null) {
            ...
            if (changedBits === 0) {
              if (
                oldProps.children === newProps.children && !hasContextChanged()
              ) {
                return bailoutOnAlreadyFinishedWork(
                  current2,
                  workInProgress2,
        ...
        function beginWork(current2, workInProgress2, renderLanes2) {
          ...
          switch (workInProgress2.tag) {
            ...
            case FunctionComponent: {
              ...
              var resolvedProps = workInProgress2.elementType === _Component
                ? unresolvedProps
            ...
            case ClassComponent: {
              ...
              var _resolvedProps = workInProgress2.elementType === _Component2
                ? _unresolvedProps
            ...
            case IncompleteClassComponent: {
              ...
              var _resolvedProps4 = workInProgress2.elementType === _Component3
                ? _unresolvedProps4
        ...
        function ensureRootIsScheduled(root2, currentTime) {
          ...
          var nextLanes = getNextLanes(
            root2,
            root2 === workInProgressRoot ? workInProgressRootRenderLanes
            : NoLanes,
          );
        ...
        function flushDiscreteUpdates() {
          if (
            (executionContext &
              (BatchedContext | RenderContext | CommitContext)) !== NoContext
          ) {
            {
        ...
        function warnAboutUpdateOnNotYetMountedFiberInDEV(fiber) {
          {
            ...
            var componentName = getComponentName(fiber.type) ||
              "ReactComponent";
        ...
        function warnAboutUpdateOnUnmountedFiberInDEV(fiber) {
          {
            ...
            if (
              ...
              tag !== MemoComponent && tag !== SimpleMemoComponent &&
              tag !== Block
            ) {
              return;
            }
...
For more info, visit https://reactjs.org/link/mock-scheduler`,
        ...
        function computeThreadID(root2, lane) {
          return lane * 1000 + root2.interactionThreadID;
        }
        ...
        function finishPendingInteractions(root2, committedLanes) {
          ...
          try {
            ...
            pendingInteractionMap.forEach(
              function (scheduledInteractions, lane) {
        ...
        function resolveLazyComponentTag(Component20) {
          if (typeof Component20 === "function") {
            return shouldConstruct$1(Component20)
              ? ClassComponent
              : FunctionComponent;
        ...
        ReactDOMRoot.prototype.unmount = ReactDOMBlockingRoot.prototype
          .unmount = function () {
            {
        ...
        function createRootImpl(container, tag, options2) {
          ...
          var mutableSources =
            options2 != null && options2.hydrationOptions != null &&
              options2.hydrationOptions.mutableSources || null;
        ...
        function unstable_renderSubtreeIntoContainer2(
          parentComponent,
          element,
          containerNode,
          callback,
        ...
        function renderSubtreeIntoContainer(
          ...
          return unstable_renderSubtreeIntoContainer2(
            parentComponent,
            element,
            containerNode,
            callback,
...
var require_react_dom = __commonJS4({
  "esm-build-2e9cd939fa91c0eeaf6f7ff27fca55411db625c4-fe81360e/node_modules/react-dom/index.js"(
    exports,
    module,
  ) {
    "use strict";
...
var import_react_dom = __toESM4(require_react_dom());
var $module4 = __toESM4(require_react_dom());
var {
  __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:
...
var { default: $def4, ...$rest4 } = $module4;
var mod_default4 = (import_react_dom.default ?? $def4) ?? $rest4;
let loading = true;
...
function render1(element) {
  if (loading) {
    globalThis.addEventListener("DOMContentLoaded", () => render1(element));
    return;
  }
  const dom = document.getElementById("react-root");
  mod_default4.render(element, dom);
}
const text = [
  "Scrapboxと同じ感じで選択できます",
  "大体やっていることはshokaiさんのスライドに書いてあることと同じ",
  " 文字列をspanで区切って",
  " いい感じにインデント付けて",
  " こちらもspan置いて",
  " 気合いでカーソル位置を割り出して",
  ...
  "  頑張って位置計算してレンダリング",
  "選択範囲も同じ",
  " 3つdiv用意してあると書いてあるので真似した",
  " 位置計算が面倒だけど気合でやった",
];
render1(mod_default1.createElement(Editor, {
  lines: text,
}));
